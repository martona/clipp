...
#define CLP_UI_POPUP_REGISTERS "Registers"
#define CLP_UI_POPUP_RENAME "Rename"
...
#define CLP_UI_POPUP_SAVE_TIP_MAC "Save as a register (⌘S)"
...
#define CLP_UI_PEEK "Peek"
#define CLP_UI_PEEK_HIDE "Hide"
